...
--
-- Name: pos_receipt; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.pos_receipt OWNER TO postgres;
...
--
-- Data for Name: pos_receipt; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
3597	/SELECT/emp_name,designation,phone_no,email_id/FROM/employee	2023-02-24 05:38:49+00
...
3580	/SELECT/site-BLUBLUBLU-site_name/FROM/site/;	2023-02-25 10:13:44+00
...
SELECT pg_catalog.setval('public.employee_empid_seq', 1037, true);
...
SELECT pg_catalog.setval('public.update_upid_seq', 3632, true);
